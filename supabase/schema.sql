...
CREATE OR REPLACE VIEW "public"."v_produits_base" AS
 SELECT "p"."id_produit",
...
ALTER VIEW "public"."v_produits_base" OWNER TO "postgres";
...
CREATE OR REPLACE VIEW "public"."v_produits" AS
 SELECT "id_produit",
    ...
    "lib_categorie",
    "search_concat",
    (COALESCE("qte_stock", (0)::numeric) < COALESCE("qte_min", (0)::numeric)) AS "is_alert"
   FROM "public"."v_produits_base" "v";


ALTER VIEW "public"."v_produits" OWNER TO "postgres";


CREATE OR REPLACE VIEW "public"."v_produits_plus" AS
 SELECT "id_produit",
    "code_produit",
    "designation",
    "qte_stock",
    ...
    "lib_categorie",
    (COALESCE("qte_stock", (0)::numeric) < COALESCE("qte_min", (0)::numeric)) AS "is_alert",
    "lower"(TRIM(BOTH FROM ((((COALESCE("designation", ''::"text") || ' '::"text") || COALESCE("lib_categorie", ''::"text")) || ' '::"text") || COALESCE("code_produit", ''::"text")))) AS "search_concat"
   FROM "public"."v_produits" "v";


ALTER VIEW "public"."v_produits_plus" OWNER TO "postgres";


CREATE OR REPLACE VIEW "public"."v_produits_alert" AS
 SELECT "id_produit",
    "code_produit",
    "designation",
    "qte_stock",
    ...
    "is_alert",
    "search_concat"
   FROM "public"."v_produits_plus";


ALTER VIEW "public"."v_produits_alert" OWNER TO "postgres";
...
GRANT ALL ON TABLE "public"."v_produits_base" TO "anon";
GRANT ALL ON TABLE "public"."v_produits_base" TO "authenticated";
GRANT ALL ON TABLE "public"."v_produits_base" TO "service_role";
...
GRANT ALL ON TABLE "public"."v_produits_plus" TO "anon";
GRANT ALL ON TABLE "public"."v_produits_plus" TO "authenticated";
GRANT ALL ON TABLE "public"."v_produits_plus" TO "service_role";



GRANT ALL ON TABLE "public"."v_produits_alert" TO "anon";
GRANT ALL ON TABLE "public"."v_produits_alert" TO "authenticated";
GRANT ALL ON TABLE "public"."v_produits_alert" TO "service_role";
